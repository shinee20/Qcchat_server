...
//	@Transactional
//	@Override
//	public DefaultRes insertChatRoom(int userId, RoomVO_deprecated vo){
//
//		try {
...
//		List<Rooms_deprecated> roomList = redisService.getValueList(key);
//		if (roomList.isEmpty()) {
...
//				 */
//				
//				for (Rooms_deprecated r : roomList) {
...
//
//	@Override
//	public DefaultRes editPassword(int userId,RoomVO_deprecated vo) {
...
//	@Transactional
//	@Override
//	public DefaultRes addFriends(int userId, RoomVO_deprecated vo) {
//		try {
//			roomDao.insertUsersAtRoom(vo);
